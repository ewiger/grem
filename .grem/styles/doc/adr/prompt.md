...
into a single normative decision record in the "ADR style" (a BIP/RFC × ADR
hybrid: spec-first, normative, grounded in the codebase, DRY) that a peer could
implement from without you present.
...
## Writing rules
- Use RFC 2119 keywords in CAPS — MUST, MUST NOT, SHOULD, MAY — for every normative statement.
